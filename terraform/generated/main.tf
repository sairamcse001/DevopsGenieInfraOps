...
resource "aws_lambda_function" "main" {
  filename      = "lambda_function.zip" # Replace with actual zip file or use "runtime" and "handler" for inline code
...
# IAM permissions for lambda to be triggered by S3
