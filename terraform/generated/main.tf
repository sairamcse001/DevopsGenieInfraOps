...
resource "aws_lambda_function" "main" {
  ...
  role            = "arn:aws:iam::123456789012:role/lambda_basic_execution" # Replace with proper role ARN.  This is a placeholder.
 handler         = "index.handler" # Replace with your handler
 source_code_hash = filebase64sha256("lambda.zip") # Replace with your lambda zip file
