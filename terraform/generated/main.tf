...
resource "aws_lambda_function" "main" {
  ...
  role            = "arn:aws:iam::YOUR_ACCOUNT_ID:role/lambda_basic_execution" # Replace with your lambda execution role
  handler         = "main.handler" # Replace with your handler
  source_code_hash = filebase64sha256("lambda_function.zip") # Replace with your lambda zip file
  runtime = "python3.9"
